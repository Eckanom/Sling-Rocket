...
const App: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gray-900" style={themeStyles}>
      {/* Mobile container wrapper: 9:16 aspect ratio on Desktop, Full on Mobile */}
      <div 
        className="relative w-full h-full md:max-w-[450px] md:max-h-[800px] md:aspect-[9/16] bg-game-bg overflow-hidden shadow-2xl md:rounded-xl border-game-fg md:border"
      ...
      >
        ...
        {view === 'GAME' && (
          <div className="absolute top-12 right-5 z-20 pointer-events-auto">
            <button onClick={pauseGame} className="px-4 py-1 border border-game-fg text-game-fg text-sm hover:bg-game-faint uppercase">
              // {t.menu}
            </button>
          </div>
        )}
        ...
        <style>{`
          ...
          .game-btn:active { background: var(--faint); }
